...
from apps.user.models import Profile, username_generator, file_validation
...
class TestProfileModel:
    ...
    def test_username_generator(self):
        user = Profile(email='test@example.com', first_name='TestUser')
        username = username_generator(user)
    ...
    def test_file_validation_large_file(self):
        ...
        with pytest.raises(ValidationError, match="File shouldn't be larger than 10MB."):
